/*
this is a calss called servoWave in order to propagate a wave down a line of servos, and
uses various analog pins to control wave, amplitude and frequency
*/
...
ServoWave servoWave;
int numServos = 6;//this has to be 15

/*This code demonstrates how to change the frequency and amplitude of 
a sine wave and how that affects the propagation of a wave
This code can be used to translate a wave form into physical motors

by gabriella levine adapted , exploring biomimicry itp fall class 2013
*/
...
void calcWave() {
  ...
  for (int i = 0; i < yvalues.length; i++) {
    ...
    yvalues[i] = amplitude*sin(x);//this is the crucial line 
    x+=dx;//x is the angle that is being added to in order to cycle through 
